...
CCB Mobile v8.4.0 is published as an Android APK:

- [Download ccb-mobile-v8.4.0.apk](https://github.com/SeemSeam/claude_codex_bridge/releases/download/v8.4.0/ccb-mobile-v8.4.0.apk)
...
iOS/iPadOS remain source-supported targets, but v8.4.0 release validation is
Android-focused.
