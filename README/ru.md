...
CCB 8.4.1 включает Flutter source CCB Mobile в [`mobile/`](../mobile/) и публикует Android APK через GitHub Releases:

- [Скачать CCB Mobile v8.4.1 APK](https://github.com/SeemSeam/claude_codex_bridge/releases/download/v8.4.1/ccb-mobile-v8.4.1.apk)
