...
CCB 8.6.5 включает Flutter source CCB Mobile в [`mobile/`](../mobile/) и публикует Android APK через GitHub Releases:

- [Скачать CCB Mobile v8.6.5 APK](https://github.com/SeemSeam/claude_codex_bridge/releases/download/v8.6.5/ccb-mobile-v8.6.5.apk)
