...
CCB 8.5.5 incluye el código Flutter de CCB Mobile en [`mobile/`](../mobile/) y publica el APK Android mediante GitHub Releases:

- [Descargar CCB Mobile v8.5.5 APK](https://github.com/SeemSeam/claude_codex_bridge/releases/download/v8.5.5/ccb-mobile-v8.5.5.apk)
