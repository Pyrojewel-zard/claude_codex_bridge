...
CCB 8.6.0 incluye el código Flutter de CCB Mobile en [`mobile/`](../mobile/) y publica el APK Android mediante GitHub Releases:

- [Descargar CCB Mobile v8.6.0 APK](https://github.com/SeemSeam/claude_codex_bridge/releases/download/v8.6.0/ccb-mobile-v8.6.0.apk)
...
<p align="center">
  <img src="../assets/weixin.png?v=77e83abf" alt="Grupo WeChat" width="240">
</p>
