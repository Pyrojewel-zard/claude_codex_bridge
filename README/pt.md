...
O CCB 8.6.2 inclui o código Flutter do CCB Mobile em [`mobile/`](../mobile/) e publica o APK Android pelo GitHub Releases:

- [Baixar CCB Mobile v8.6.2 APK](https://github.com/SeemSeam/claude_codex_bridge/releases/download/v8.6.2/ccb-mobile-v8.6.2.apk)
