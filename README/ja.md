...
CCB 8.6.0 では Flutter 版 CCB Mobile のソースが [`mobile/`](../mobile/) に含まれ、Android APK は GitHub Releases で公開されています。

- [CCB Mobile v8.6.0 APK をダウンロード](https://github.com/SeemSeam/claude_codex_bridge/releases/download/v8.6.0/ccb-mobile-v8.6.0.apk)
