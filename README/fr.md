...
CCB 8.4.1 inclut le code source Flutter de CCB Mobile dans [`mobile/`](../mobile/) et publie l'APK Android via GitHub Releases :

- [Télécharger l'APK CCB Mobile v8.4.1](https://github.com/SeemSeam/claude_codex_bridge/releases/download/v8.4.1/ccb-mobile-v8.4.1.apk)
